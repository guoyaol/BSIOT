        ...
        <Layout className="site-layout">
          ...
          <Content style={{ margin: '0 16px' }}>
            ...
            <Radio.Group onChange={this.onChange} value={value}>
              <Radio value={'device0001'}>device0001</Radio>
              <Radio value={'device0002'}>device0002</Radio>
              <Radio value={'device0003'}>device0003</Radio>
              <Radio value={'device0004'}>device0004</Radio>
              <Radio value={'device0005'}>device0005</Radio>
            </Radio.Group>
